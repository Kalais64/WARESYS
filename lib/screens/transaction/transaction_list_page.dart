                ...
                child: ValueListenableBuilder<String>(
                  ...
                  builder: (context, value, _) => TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: type == TransactionType.sales ? 'Cari transaksi penjualan...' : 'Cari transaksi pembelian...'
                    ),
              ...
              return StreamBuilder<List<TransactionModel>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return DropdownButton<String?>(
                    ...
                    isExpanded: true,
                    items: [
                      DropdownMenuItem<String?>(value: null, child: Text('Semua Produk')),
                      ...allProducts.map((p) => DropdownMenuItem<String?>(value: p, child: Text(p)))
                    ],
                      ...
                      child: Padding(
                        ...
                        child: ListTile(
                          ...
                          leading: CircleAvatar(
                            backgroundColor: type == TransactionType.sales ? Colors.blue : Colors.green,
                            child: Icon(type == TransactionType.sales ? Icons.point_of_sale : Icons.shopping_cart, color: Colors.white),
                          ),
                          title: Text(trx.customerSupplierName, style: const TextStyle(fontWeight: FontWeight.w600)),
                          subtitle: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Tanggal: $dateStr'),
                              Text('Total: ${trx.total.toStringAsFixed(2)}'),
