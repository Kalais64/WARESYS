    ...
    return Card(
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(
              isIncome ? Icons.arrow_downward : isAdmin ? Icons.account_balance_wallet : Icons.arrow_upward,
              color: isIncome ? Colors.green : isAdmin ? Colors.blue : Colors.red
            ),
            const SizedBox(width: 12),
            Expanded(
              child: Column(
  ...
  void _showEditSaldoDialog(BuildContext context, double currentSaldo) async {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('Edit Saldo Kas Utama'),
        content: TextFormField(
          controller: _controller,
          keyboardType: TextInputType.number,
          decoration: InputDecoration(labelText: 'Saldo Baru (Rp)'),
        ),
        actions: [
