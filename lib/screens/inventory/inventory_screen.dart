...
class _InventoryScreenState extends State<InventoryScreen> {
  ...
  static const List<Color> _colors = <Color>[
    Color(0xFFF4511E), // Produk - deepOrange[700]
    Colors.blue,        // Mutasi Stok
    Colors.indigo,      // Riwayat Stok
    Colors.green,       // Export
    Color(0xFFF4511E), // Profile (same as module)
  ];
              ...
              DropdownButton<String>(
                ...
                items: ['']
                    ...
                    .map((cat) => DropdownMenuItem(
                          value: cat,
                          child: Text(cat.isEmpty ? 'Semua' : cat),
                        ))
                    .toList(),
